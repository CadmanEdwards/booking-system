...
<link rel="stylesheet" 
      href="{{ url('public/css') }}/jquery-ui.css">
<link rel="stylesheet"
      href="//cdn.datatables.net/1.10.9/css/jquery.dataTables.min.css"/>
<link rel="stylesheet"
      href="{{ url('public/css') }}/select.dataTables.min.css"/>
<link rel="stylesheet"
      href="//cdn.datatables.net/buttons/1.2.4/css/buttons.dataTables.min.css"/>
<link rel="stylesheet"
      href="{{ url('public/css') }}/jquery-ui-timepicker-addon.min.css"/>
<link rel="stylesheet"
      href="{{ url('public/css') }}/bootstrap-datepicker.standalone.min.css"/>

<link rel="stylesheet" href="{{ url('quickadmin/css') }}/custom_size.css"/>