    ...
    <div class="page-sidebar navbar-collapse collapse">
        <ul class="page-sidebar-menu"
            ...
            @can('client_without_moneybird')
             ...
             <li class="{{ $request->segment(2) == 'clientwithoutmoneybird' ? 'active' : '' }}">
                <a href="{{ route('admin.clients.clientwithoutmoneybird') }}">
                    <i class="fa fa-users"></i>
                    <span class="title">Client Lead</span>
                </a>
            </li>
             @endcan
           @can('calandar_access')
           ...
           {{-- @if(auth()->user()->role->id==3) --}}
            ...
            @endcan
            @if(Auth::user()->id == 1)
            <li class="{{ $request->segment(2) == 'incoming-invoices' ? 'active' : '' }}">
                <a href="{{ url('admin/incoming-invoices') }}">
                    <i class="fa fa-calendar"></i>
                    <span class="title">Incoming Invoices</span>
                </a>
            </li>

            <li class="{{ $request->segment(2) == 'create-incoming-invoice' ? 'active' : '' }}">
                <a href="{{ url('admin/create-incoming-invoice') }}">
                    <i class="fa fa-calendar"></i>
                    <span class="title">Create Incoming Invoice</span>
                </a>
            </li>
            @endif
