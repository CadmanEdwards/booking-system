    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
             <div class="col-xs-12 form-group">
                ...
                <div class="col-xs-12 form-group">
                    {!! Form::label('cmp_vat_no', 'VAT number', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-12 form-group">
                    {!! Form::label('cmp_bank_ac_no', 'Bank number', ['class' => 'control-label']) !!}
                ...
                <div class="col-xs-12 form-group">
                    {!! Form::label('cmp_bank_ac_name', 'Bank Acount Name', ['class' => 'control-label']) !!}
