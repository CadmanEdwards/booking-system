        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text" class="form-control" name="amount" id="currency-field" pattern="^{1,3}(,\d{3})*(\.\d+)?$" value="{{ old('amount') }}" data-type="currency" placeholder="1,000,000.00">
{{--                    {!! Form::text('amount', old('amount'), ['class' => 'form-control', 'placeholder' => '','min' => '1' , 'pattern' => "^\d+(\.|\,)\d{2}$"]) !!}--}}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    <input type="text"  class="form-control date" name="invoice_date" id="invoice_date" placeholder="dd-mm-yyyy">
                </div>
            </div>
                <div class="row">
                    <div class="col-xs-12 form-group">
