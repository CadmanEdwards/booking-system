...
class UsersController extends Controller
{
    ...
    public function getSettings(){
        ...
        return view('admin.users.settings',['settings' => $settings,'price_fee' => $price_fee  ]);
    }
    public function postSettings(Request $request){
        ...
        DB::table('price_fee')->truncate();
        foreach ($price_fee as $item => $value){

            DB::table('price_fee')->insert([
                'price' => $value['price'],
                'fee' => $value['fee']
            ]);
        }
        //     $settings->dashboard_text  = $request['dashboard_text'];
        //   $settings->update();
